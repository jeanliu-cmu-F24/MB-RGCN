...
class Recommender:
	...
	def messagePropagate(self, lats, adj):
		return FC(tf.sparse.sparse_dense_matmul(adj, lats), args.latdim, reg=True, activation=self.actFunc)
	...
	def defineModel(self):
		...
		ulat = self.messagePropagate(iEmbed0, self.adjs)
		ilat = self.messagePropagate(uEmbed0, self.tpAdjs)
